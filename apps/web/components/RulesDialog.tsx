  ...
  return (
    <Dialog>
      ...
      <DialogContent className="h-2/3 px-0">
        ...
        <div className="flex flex-col gap-6 text-slate-900 overflow-y-auto px-6">
